...
-[__2024/06__] A Review of Prominent Paradigms for LLM-Based Agents: Tool Use (Including RAG), Planning, and Feedback Learning  
...
-[__2024/01__] A Comprehensive Study on LLM Agent Challenges(AAAI)  
-[__2024/01__] Exploring Large Language Model based Intelligent Agents: Definitions, Methods, and Prospects [paper](https://arxiv.org/abs/2401.03428)  
...
-[__2023/10__] AgentBench: Evaluating LLMs as Agents [paper](https://arxiv.org/abs/2308.03688)  
-[__2023/09__] The Rise and Potential of Large Language Model Based Agents: A Survey [paper](https://arxiv.org/abs/2309.07864)  
-[__2023/09__] An In-depth Survey of Large Language Model-based Artificial Intelligence Agents [paper](https://arxiv.org/abs/2309.14365)  
-[__2023/06__] Next Steps for Human-Centered Generative AI: A Technical Perspective [paper](https://arxiv.org/abs/2306.15774)  


**Multiple LLM Agents:**  

-[__2024/12__] LLM-Based Multi-Agent Systems for Software Engineering: Vision and the Road AheadPreprint [paper](https://arxiv.org/abs/2404.04834)  
...
-[__2024/09__] How Far Are We on the Decision-Making of LLMs? Evaluating LLMs' Gaming Ability in Multi-Agent Environments [paper](https://arxiv.org/abs/2403.11807)  
-[__2024/08__] GenAI-powered Multi-Agent Paradigm for Smart Urban Mobility: Opportunities and Challenges for Integrating Large Language Models (LLMs) and Retrieval-Augmented Generation (RAG) with Intelligent Transportation Systems [paper](https://arxiv.org/abs/2409.00494)  
-[__2024/07__] Multi-Agent, Human-Agent and Beyond: A Survey on Cooperation in Social DilemmasPreprint [paper](https://arxiv.org/abs/2402.17270)  
-[__2024/06__] Multi-Modal and Multi-Agent Systems Meet Rationality: A Survey [paper](https://arxiv.org/abs/2406.00252)  
-[__2024/05__] Exploring collaboration mechanisms for llm agents: A social psychology view [paper](https://arxiv.org/abs/2310.02124)  
-[__2024/03__] System for systematic literature review using multiple ai agents: Concept and an empirical evaluation [paper](https://arxiv.org/abs/2403.08399)  
-[__2024/02__] A Survey on Context-Aware Multi-Agent Systems: Techniques, Challenges and Future Directions [paper](https://arxiv.org/abs/2402.01968)  
...
-[__2024/02__] LLM multi-agent systems: Challenges and open problems [paper](https://arxiv.org/abs/2402.03578)  
...
-[__2024/06__] AI Agents Under Threat: A Survey of Key Security Challenges and Future Pathways [paper](https://arxiv.org/abs/2406.02630)  
...
**Applications:**   
 ...
 In Coding:  
-[__2025/01__] Language Models for Code Optimization: Survey, Challenges and Future Directions [paper](https://arxiv.org/abs/2501.01277)  
-[__2024/11__] Human-In-the-Loop Software Development Agents [paper](https://arxiv.org/abs/2411.12924)  
-[__2024/11__] A systematic survey on large language models for algorithm design [paper](https://arxiv.org/abs/2410.14716)  
-[__2024/10__] Agentless: Demystifying LLM-based Software Engineering Agents [paper](https://arxiv.org/abs/2407.01489)  
-[__2024/09__] Surveying the MLLM Landscape: A Meta-Review of Current Surveys [paper] [paper](https://arxiv.org/abs/2409.18991)  
...
-[__2024/08__] A survey on integration of large language models with intelligent robots [paper](https://link.springer.com/article/10.1007/s11370-024-00550-5)  
...
-[__2023/11__]Large language models for robotics: A survey [paper](https://arxiv.org/abs/2311.07226)  

  In Others:  
-[__2024/12__] Recommender Systems in the Era of Large Language Model Agents: A Survey [paper]()  
-[__2024/12__] LLM-Augmented Agent-Based Modelling for Social Simulations: Challenges and Opportunities [paper](https://ebooks.iospress.nl/volumearticle/68007)  
-[__2024/12__] TravelAgent: Generative Agents in the Built Environment [paper](https://arxiv.org/abs/2412.18985)  
-[__2024/12__] A Survey on Large Language Model-based Agents for Statistics and Data Science [paper](https://arxiv.org/abs/2412.14222)  
-[__2024/12__] OS Agents: A Survey on MLLM-Based Agents for General Computing Devices Use  
-[__2024/12__] A Survey on Large Language Model-Based Social Agents in Game-Theoretic Scenarios [paper](https://arxiv.org/abs/2412.03920)  
...
-[__2024/12__] A Complete Survey on LLM-based AI Chatbots [paper](https://arxiv.org/abs/2406.16937)  
-[__2024/11__] Generalist virtual agents: A survey on autonomous agents across digital platforms [paper](https://arxiv.org/abs/2411.10943)  
...
-[__2024/10__] From Persona to Personalization: A Survey on Role-Playing Language Agents [paper](https://arxiv.org/abs/2404.18231)  
-[__2024/10__] Llm4drive: A survey of large language models for autonomous driving [paper](https://openreview.net/forum?id=ehojTglbMj)  
-[__2024/09__] Turn every application into an agent: Towards efficient human-agent-computer interaction with api-first llm-based agents [paper](https://arxiv.org/abs/2409.17140)  
-[__2024/09__] A Survey of LLM-based Agents: Theories, Technologies, Applications and Suggestions [paper](https://ieeexplore.ieee.org/abstract/document/10748304)  
-[__2024/07__] Revolutionizing Bridge Operation and maintenance with LLM-based Agents: An Overview of Applications and InsightsPreprint [paper](https://arxiv.org/abs/2407.10064)  
